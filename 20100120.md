[Issue 84](https://code.google.com/p/lino/issues/detail?id=84) (Extend window\_config) habe ich begonnen, weil wir beim Speichern der Fensterpositionen momentan eine Serie von kleinen Bugs haben:
